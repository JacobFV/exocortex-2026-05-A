...
- Continuity operational-state helpers currently accept calibration profiles and safety grants through graph patches, mark superseded calibration profiles as non-active while keeping them inspectable, and provide branch-scoped readers for active profiles and grants.
